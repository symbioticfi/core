...
| `requestSlash` | no    | 271,935 ($0.06) |
| `requestSlash` | yes   | 271,935 ($0.06) |
| `executeSlash` | no    | 372,945 ($0.08) |
| `executeSlash` | yes   | 372,945 ($0.08) |
...
| `UniversalSlasher::slashableStake`                    | 139,617 ($0.03) | heavy path (read-only)   |
| `VaultV2::delegator` (via proxy)                      |     883 ($0.00) | delegator address lookup |
| `UniversalDelegator::onSlash`                         | 109,764 ($0.02) | delegator hook           |
...
| `VaultV2::onSlash` (via proxy)                        |  51,541 ($0.01) | vault accounting + burn  |
...
| `UniversalSlasher::_checkNetworkMiddleware`           |   5,569 ($0.00) | middleware check                  |
| `VaultV2::epochDuration` (via proxy)                  |   7,400 ($0.00) | reads epoch duration              |
| `UniversalSlasher::slashableStake`                    | 139,617 ($0.03) | higher due to hint decoding/usage |
| `VaultV2::delegator` (via proxy)                      |     883 ($0.00) | delegator address lookup          |
| `UniversalDelegator::onSlash`                         | 109,764 ($0.02) | delegator hook                    |
| `VaultV2::delegator` (via proxy, for getIsNoAdapters) |     883 ($0.00) | delegator address lookup          |
| `UniversalDelegator::getIsNoAdapters`                 |   1,624 ($0.00) | adapter mode check                |
