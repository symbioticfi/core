...
/**
 * @title ISecuritizeSubAccount
 * @notice Interface for Securitize request-holder subaccounts.
 */
interface ISecuritizeSubAccount {
    /* ERRORS */
    ...
    /**
     * @notice Requests redemption of held Securitize tokens.
     */
