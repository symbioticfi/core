...
```shell
// function run(address vaultRegistry, address owner, address collateral, uint48 epochDuration, uint48 vetoDuration, uint48 slashDuration, uint256 adminFee, bool depositWhitelist)
