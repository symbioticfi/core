...
abstract contract SymbioticCoreBindingsBase is Test {
    ...
    function _deposit_SymbioticCore(
        ...
        address onBehalfOf,
        uint256 amount
    ) internal virtual broadcast(who) returns (uint256 depositedAmount, uint256 mintedShares) {
    ...
    function _withdraw_SymbioticCore(
        ...
        address claimer,
        uint256 amount
    ) internal virtual broadcast(who) returns (uint256 burnedShares, uint256 mintedShares) {
    ...
    function _redeem_SymbioticCore(
        ...
        address claimer,
        uint256 shares
    ) internal virtual broadcast(who) returns (uint256 withdrawnAssets, uint256 mintedShares) {
    ...
    function _claim_SymbioticCore(
        ...
        address recipient,
        uint256 epoch
    ) internal virtual broadcast(who) returns (uint256 amount) {
    ...
    function _setDepositWhitelist_SymbioticCore(
        address who,
        address vault,
        bool status
    ) internal virtual broadcast(who) {
    ...
    function _setIsDepositLimit_SymbioticCore(
        address who,
        address vault,
        bool status
    ) internal virtual broadcast(who) {
    ...
    function _setDepositLimit_SymbioticCore(
        address who,
        address vault,
        uint256 limit
    ) internal virtual broadcast(who) {
    ...
    function _grantRole_SymbioticCore(
        address who,
        address where,
        bytes32 role,
        address account
