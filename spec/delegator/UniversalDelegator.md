...
- `childrenPendingCumulative`: cumulative “pending free” amount used to delay re-use of freed stake.
...
- Decreasing size below the slot’s current allocation schedules a “pending free” amount on the parent via `childrenPendingCumulative`.
