...
contract TestnetMigratablesFactory is Registry, Ownable, IMigratablesFactory {
...
contract TestnetVaultFactory is TestnetMigratablesFactory, IVaultFactory {
    constructor(address owner_) TestnetMigratablesFactory(owner_) {}
}
