...
// forge script script/update/multisig/SlashMultisig.s.sol:SlashMultisigScript --rpc-url=RPC --private-key PRIVATE_KEY --broadcast

contract SlashMultisigScript is SlashBaseScript {
