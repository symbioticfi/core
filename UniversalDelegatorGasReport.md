...
| Call           | Hints |             Gas |
| -------------- | ----- | --------------: |
| `stakeForAt`   | no    | 252,669 ($0.06) |
| `stakeForAt`   | yes   | 252,669 ($0.06) |
| `requestSlash` | no    | 293,582 ($0.06) |
| `requestSlash` | yes   | 293,582 ($0.06) |
| `executeSlash` | no    | 458,763 ($0.10) |
| `executeSlash` | yes   | 458,763 ($0.10) |
...
| `UniversalSlasher::slashableStake`                    | 118,252 ($0.03) | heavy path (read-only)   |
| `VaultV2::delegator` (via proxy)                      |     883 ($0.00) | delegator address lookup |
| `UniversalDelegator::onSlash`                         | 151,864 ($0.03) | delegator hook           |
| `VaultV2::delegator` (via proxy, for getIsNoAdapters) |     883 ($0.00) | delegator address lookup |
| `UniversalDelegator::getIsNoAdapters`                 |   1,624 ($0.00) | adapter mode check       |
| `VaultV2::onSlash` (via proxy)                        | 116,636 ($0.03) | vault accounting + burn  |
...
| `UniversalSlasher::_checkNetworkMiddleware`           |   5,569 ($0.00) | middleware check                  |
| `VaultV2::epochDuration` (via proxy)                  |   7,400 ($0.00) | reads epoch duration              |
| `UniversalSlasher::slashableStake`                    | 118,252 ($0.03) | higher due to hint decoding/usage |
| `VaultV2::delegator` (via proxy)                      |     883 ($0.00) | delegator address lookup          |
| `UniversalDelegator::onSlash`                         | 151,864 ($0.03) | delegator hook                    |
| `VaultV2::delegator` (via proxy, for getIsNoAdapters) |     883 ($0.00) | delegator address lookup          |
| `UniversalDelegator::getIsNoAdapters`                 |   1,624 ($0.00) | adapter mode check                |
...
| Component                                         |            Gas | Notes                |
| ------------------------------------------------- | -------------: | -------------------- |
| `VaultV2::deallocateAdapters`                     |  2,148 ($0.00) | adapter deallocation |
