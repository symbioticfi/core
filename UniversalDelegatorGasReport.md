...
| Call | Hints | Gas |
| --- | --- | ---: |
| `stakeForAt` | no | 144,167 ($0.03) |
| `stakeForAt` | yes | 144,167 ($0.03) |
| `requestSlash` | no | 297,290 ($0.06) |
| `requestSlash` | yes | 297,290 ($0.06) |
| `executeSlash` | no | 649,350 ($0.14) |
| `executeSlash` | yes | 649,350 ($0.14) |
...
| `UniversalSlasher::slashableStake` | 129,727 ($0.03) | heavy path (read-only) |
| `VaultV2::delegator` (via proxy) | 2,233 ($0.00) | delegator address lookup |
| `UniversalDelegator::onSlash` | 120,552 ($0.03) | delegator hook |
...
| `UniversalSlasher::_checkNetworkMiddleware` | 5,623 ($0.00) | middleware check |
| `VaultV2::epochDuration` (via proxy) | 7,778 ($0.00) | reads epoch duration |
| `UniversalSlasher::slashableStake` | 129,727 ($0.03) | higher due to hint decoding/usage |
| `VaultV2::delegator` (via proxy) | 2,233 ($0.00) | delegator address lookup |
| `UniversalDelegator::onSlash` | 120,552 ($0.03) | delegator hook |
| `VaultV2::onSlash` (via proxy) | 337,276 ($0.07) | vault accounting + burn |
| `UniversalSlasher::_burnerOnSlash` | 165 ($0.00) | burner hook |
